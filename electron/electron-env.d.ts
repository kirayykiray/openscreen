...
interface Window {
  electronAPI: {
    ...
    getCursorData: (videoPath: string) => Promise<{ success: boolean; data?: import('../src/lib/cursor/cursorTracker').CursorData; message?: string }>
    getCursorPosition: () => Promise<{ x: number; y: number }>
    getDisplayBounds: () => Promise<{ x: number; y: number; width: number; height: number; scaleFactor: number }>
